...
const events = [
  {
    image: '/Images/news-event-rei-2025.png',
    tag: 'NEWS & EVENTS',
  ...
  {
    image: '/Images/news-event-500gw-panel.png',
    tag: 'PANEL',
  ...
  {
    image: '/Images/news-event-europe-energy.png',
    tag: 'EXHIBITION',
  ...
  {
    image: '/Images/news-event-san-diego.png',
    tag: 'EXHIBITION',
    tagClass: 'bg-[#FF7F0026] text-[#FF7F00]',
    date: 'FEB 18–20, 2026',
  ...
  {
    image: '/Images/news-event-bes-2026.png',
    tag: 'SUMMIT',
...
const NewsEventsSection: React.FC<NewsEventsSectionProps> = () => {
  return (
    <section id="events-conferences" className="px-4 py-10 sm:px-6 lg:px-8 lg:py-20">
