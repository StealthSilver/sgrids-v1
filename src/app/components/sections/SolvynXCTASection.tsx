...
export interface SolvynXCTASectionProps {}
...
const SolvynXCTASection: React.FC<SolvynXCTASectionProps> = () => {
  return (
    <section id="solvyn-x-cta" className="px-4 py-10 sm:px-6 lg:px-8 lg:py-20">
        ...
        <div className="flex flex-col items-center gap-8 rounded-[14px] border border-[#EFE6DF] bg-[#FFFFFF] px-5 py-8 shadow-[0px_7.72px_9.64px_0px_#FF6A0026] sm:px-8 sm:py-10 lg:flex-row lg:items-center lg:justify-between lg:gap-12 lg:px-10 lg:py-12">
          <div className="min-w-0 flex-1 text-left">
            ...
            <p className="mt-4 max-w-[36rem] [font-family:var(--font-ibm-plex-sans)] text-[15px] leading-[1.4] text-[#7F7F7F] sm:text-base">
              See how Solvyn X connects your assets, reduces integration time, and becomes the data
              backbone of your entire operational stack.
            </p>
...
export default SolvynXCTASection
