...
export interface AuraHeroSectionProps {}
        ...
        <div className="grid items-center gap-8 lg:grid-cols-[1fr_0.95fr] lg:gap-10 xl:gap-12">
          <div className="flex flex-col items-start">
            ...
            <p className="mt-5 max-w-[32rem] [font-family:var(--font-ibm-plex-sans)] text-sm leading-relaxed text-[#7F7F7F] sm:text-base">
              A decision intelligence platform for renewable, hybrid, and BESS operations combining
              digital twins, AI forecasting, BESS scheduling, DSM intelligence, and market
              optimization into a single decision engine.
            </p>
            ...
            <div className="mt-7 flex flex-wrap items-center gap-3">
              ...
              <Link
                href="/#home-cta"
                className="inline-flex items-center justify-center rounded-full border border-[#E9D8CE] bg-white px-6 py-1.5 text-sm font-semibold leading-5 tracking-[0rem] text-[#1C1B1B] transition-colors duration-200 hover:border-[#FF7F00] hover:bg-[#FFF8F2] [font-family:var(--font-ibm-plex-sans)]"
              >
                Download Data Sheet
              </Link>
            </div>
