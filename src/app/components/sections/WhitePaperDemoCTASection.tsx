...
export interface WhitePaperDemoCTASectionProps {}
...
const WhitePaperDemoCTASection: React.FC<WhitePaperDemoCTASectionProps> = () => {
  return (
    <section id="white-paper-demo-cta" className="px-4 py-10 sm:px-6 lg:px-8 lg:py-20">
        ...
        <div className="flex flex-col gap-6 rounded-[14px] border border-[#EFE6DF] bg-[#FFFFFF] px-5 py-8 shadow-[0px_7.72px_9.64px_0px_#FF6A0026] sm:px-8 sm:py-10 lg:flex-row lg:items-center lg:gap-10 lg:px-10 lg:py-12">
          ...
          <div className="min-w-0 flex-1">
            ...
            <p className="mt-4 max-w-[40rem] [font-family:var(--font-ibm-plex-sans)] text-[15px] leading-[1.4] text-[#1C1B1B] sm:text-base">
              Talk To The SGA Team About The Technical Challenges Covered In Our White Papers And
              How Solvyn Addresses Them In Live Deployments.
            </p>
...
export default WhitePaperDemoCTASection
